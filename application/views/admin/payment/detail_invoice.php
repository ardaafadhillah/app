<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?= site_url('admin/invoice/pdf/' . $invoice->order_id) ?>"
                class="btn btn-primary shadow-md mr-2">Print</a>
        ...
        <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
            <div class="box p-5 rounded-md">
                ...
                <div class="flex items-center mt-3"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Payment Method:&nbsp;</b> Direct Bank Transfer
                </div>
                <div class="flex items-center mt-3"> <i data-lucide="calendar" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Purchase Date:&nbsp;</b> <?= $invoice->transaction_time ?>
                </div>
                <div class="flex items-center mt-3"> <i data-lucide="clock" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Transaction Status:&nbsp;</b>
                    <?php if ($invoice->status == "0") { ?>
                        <span class="bg-warning/20 text-warning rounded px-2 ml-1">Tertunda</span>
                    <?php } else if ($invoice->status == "1") { ?>
                            <span class="bg-success/20 text-success rounded px-2 ml-1">Berhasil</span>
                    <?php } ?>
                </div>
            </div>
            <div class="box p-5 rounded-md mt-5">
                ...
                <div class="flex items-center mt-3"> <i data-lucide="calendar" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Phone Number:</b>&nbsp; <?= $invoice->mobile_phone ?>
                </div>
            </div>
            <div class="box p-5 rounded-md mt-5">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                ...
                <div class="flex items-center mt-3"> <i data-lucide="calendar" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Tracking Order:</b>&nbsp; <?= $invoice->tracking_id ?> <i data-lucide="copy"
                        class="w-4 h-4 text-slate-500 ml-2"></i>
                </div>
                <div class="flex items-center mt-3"> <i data-lucide="map-pin" class="w-4 h-4 text-slate-500 mr-2"></i>
                    <b>Address:</b>&nbsp; <?= $invoice->alamat ?>, <?= $invoice->city ?>.
                </div>
            </div>
        </div>
