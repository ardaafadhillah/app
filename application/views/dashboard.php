    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <input type="text" id="search-input" class="form-control w-56 box pr-10" placeholder="Cari...">
            ...
            <?php foreach ($product as $row): ?>
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3 product-item"
                    data-name="<?= strtolower($row->nama_brg) ?>">
                    <div class="box">
                        <div class="p-5">
                            <div
                                ...
                                <span
                                    class="absolute top-0 bg-pending/80 text-white text-xs m-5 px-2 py-1 rounded z-10">Unggulan</span>
                            ...
                            <div class="text-slate-600 dark:text-slate-500 mt-5">
                                ...
                                <div class="flex items-center mt-2"> <i data-lucide="layers" class="w-4 h-4 mr-2"></i>
                                    Remaining Stock: <?= number_format($row->stok, 0, ',', '.') ?> </div>
