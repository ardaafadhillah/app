                ...
                <ul class="post__tabs nav nav-tabs flex-col sm:flex-row bg-slate-200 dark:bg-darkmode-800"
                    ...
                    <li class="nav-item">
                        <button title="Fill in the article content" data-tw-toggle="tab" data-tw-target="#content"
                            class="nav-link tooltip w-full sm:w-200 py-4 active" id="content-tab" role="tab"
                            aria-controls="content" aria-selected="true"> <i data-lucide="file-text"
                                class="w-4 h-4 mr-2"></i> Detail Belanja </button>
                    </li>
                </ul>
                    ...
                    <form id="payment-form" action="<?= site_url('dashboard/checkout_proccess') ?>" method="post">
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Nama Pembeli <small
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Email Address <small
                                                class="text-danger">*</small></label>
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">No Handphone <small
                                                class="text-danger">*</small></label>
                                        <input type="text" id="mobile_phone" name="mobile_phone" class="form-control"
                                            placeholder="Nomor Handphone Kamu" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Alamat Lengkap <small
                                                class="text-danger">*</small></label>
                                        <input type="text" id="alamat" name="alamat" class="form-control"
                                            placeholder="Alamat Rumah" autocomplete="off" required>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Catatan Untuk Produk Yang Dikirimkan
                                            <small class="text-danger">*</small></label>
                                        <input type="text" class="form-control" id="kode_pos" name="kode_pos"
                                            placeholder="Pastikan Tidak Ada Data Pribadi" autocomplete="off" required>
                                    </div>

                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Jasa Pengiriman<small
                                                class="text-danger">*</small></label>
                            ...
                            <div class="flex mt-5">
                                <a href="<?= site_url('dashboard/detail_cart') ?>"
                                    class="btn w-32 border-slate-300 dark:border-darkmode-400 text-slate-500">My
                                    Cart</a>
                                <button type="submit" class="btn btn-primary w-32 shadow-md ml-auto">Bayar</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal"
                        ...
                        <div class="ml-auto font-medium">6750527090 / Archie Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal"
                        class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">1918009817 / Archie Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal"
                        class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">6721598021 / Archie Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal"
                        class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                ...
                <div class="box p-5 mt-5">
                    <div class="flex">
                        <div class="mr-auto">Total Harga Produk</div>
