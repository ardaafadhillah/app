                ...
                <div class="notification-content pt-2 dropdown-menu">
                    <div class="notification-content__box dropdown-content">
                            ...
                            <div class="cursor-pointer relative flex items-center ">
                                ...
                                <div class="ml-2 overflow-hidden">
                                    ...
                                    <div class="w-full truncate text-slate-500 mt-0.5">
                                        <?php echo $items['options']['keterangan']; ?>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <button class="btn btn-sm btn-rounded-primary mt-4"><span class="text-uppercase"><a
                                    href="<?= site_url('dashboard/detail_cart') ?>">KERANJANG</a></span></button>
                    </div>
                </div>
            </div>
            <!-- END: Notifications -->
                    ...
                    <ul
                        ...
                        <li>
                            <a href="<?= site_url('profile') ?>" class="dropdown-item hover:bg-white/5"> <i
                                    data-lucide="user" class="w-4 h-4 mr-2"></i> My Profile </a>
                        </li>
                        <li>
                            <a href="<?= site_url('change_password') ?>" class="dropdown-item hover:bg-white/5"> <i
                                    data-lucide="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                        </li>
                        <li>
                            <hr class="dropdown-divider border-white/[0.08]">
                        </li>
