        ...
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            <div class="flex w-full sm:w-auto">
                <div class="w-48 relative text-slate-500">
                    <input type="text" class="form-control w-48 box pr-10" placeholder="Cari berdasarkan nama..">
            ...
            <div class="w-full xl:w-auto flex flex-wrap xl:flex-nowrap items-center gap-y-3 mt-3 xl:mt-0">
                <a href="<?= site_url('admin/product/add') ?>" class="btn btn-primary shadow-md mr-2"> <i
                        data-lucide="plus" class="w-4 h-4"></i></a>
                ...
                <tbody>
                    <?php foreach ($product as $row): ?>
                        <tr class="intro-x">
                            ...
                            <td class="text-center whitespace-nowrap">Rp. <?= number_format($row->harga, 0, ',', '.') ?>
                            </td>
                            <td class="w-40">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <a class="flex items-center text-danger"
                                        ...
                                        onclick="return confirm('Yakin Hapus')"> <i data-lucide="" class="w-4 h-4 mr-1"></i>
                                        Delete </a>
                                </div>
                            </td>
                        </tr>
