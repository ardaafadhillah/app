                                    ...
                                    <div class="grid grid-cols-12 gap-x-5">
                                        ...
                                        <div class="col-span-12 2xl:col-span-6">
                                            <div class="mt-3 2xl:mt-0">
                                                ...
                                                <input id="update-profile-form-1" type="number" class="form-control"
                                                    name="stok" value="<?= $row->stok ?>">
                                            </div>
                                            <div class="mt-3">
                                                <label for="update-profile-form-4" class="form-label">Harga Produk</label>
                                                <input id="update-profile-form-4" type="number" class="form-control"
                                                    name="harga" value="<?= $row->harga ?>">
                                            </div>
                                        </div>
                                        <div class="col-span-12">
                                            <div class="mt-3">
                                                <label for="update-profile-form-5" class="form-label">Deskripsi
                                                    Produk</label>
                                        ...
                                        <div class="col-span-12">
                                            <div class="mt-3">
                                                <label for="update-profile-form-6" class="form-label">Gambar Produk</label>
