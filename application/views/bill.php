                ...
                <tbody>
                    <?php foreach ($bill as $row): ?>
                        <tr class="intro-x">
                            ...
                            <td class="w-40 !py-4"> <a
                                    class="underline decoration-dotted whitespace-nowrap"><?= $row->tracking_id ?></a> </td>
                            <td class="w-40">
                                <a href=""
                            ...
                            <td>
                                <?php if ($row->status == "0") { ?>
                                    <div class="flex items-center whitespace-nowrap text-pending"> Tertunda </div>
                                <?php } else if ($row->status == "1") { ?>
                                        <div class="flex items-center whitespace-nowrap text-success"> Berhasil </div>
                                <?php } ?>
                            </td>
                            <td>
                                <?php if (empty($row->gambar)) { ?>
                                    <a data-tw-toggle="modal" data-tw-target="#upload-confirmation-modal"
                                        class="btn btn-sm btn-rounded-primary">Upload Bukti</a>
                                <?php } else { ?>
                                ...
                                <div class="text-slate-500 mt-2">
                                    ...
                                    <div class="mt-3">
                                        <div class="input-group">
                                            ...
                                            <input id="crud-form-3" name="gambar" type="file" class="form-control"
                                                value="<?= $row->gambar ?>" placeholder="Quantity"
