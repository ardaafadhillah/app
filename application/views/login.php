...
<head>
  ...
  <title><?= $title ?> | Archie Store</title>
  <!-- BEGIN: CSS Assets-->
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        <a href="" class="-intro-x flex items-center pt-5">
          ...
          <span class="text-white text-lg ml-3"> Archie Store </span>
        </a>
        <div class="my-auto">
          <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16"
            src="<?= site_url('asset') ?>/admin/dist/images/illustration.svg">
          <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
            Kualitas yang Anda Cari,
            <br>
            Harga yang Anda Inginkan.
          </div>
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Pilih. Beli. Nikmati Hanya
            Di Archie Store</div>
        </div>
      </div>
      <!-- END: Login Info -->
      ...
      <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
        <div
          ...
          <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">ARCHIE STORE</div>
          <form action="<?= site_url('welcome') ?>" method="post">
            <div class="intro-x mt-8">
              <input type="text" class="intro-x login__input form-control py-3 px-4 block" name="email" required
                autocomplete="off" placeholder="Email">
              <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" name="password"
                required autocomplete="off" placeholder="Kata Sandi">
            </div>
            ...
            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
              ...
              <a href="<?= site_url('register') ?>"
                class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Mendaftar</a>
            </div>
          </form>
          <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left"> Dengan
            Mendaftar,Menyetujui <a class="text-primary dark:text-slate-200" href="">Syarat dan Ketentuan</a> & <a
              class="text-primary dark:text-slate-200" href="">Kebijakan Privasi</a> </div>
        </div>
      </div>
      <!-- END: Login Form -->
    </div>
