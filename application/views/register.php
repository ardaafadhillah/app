        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Pilih. Beli.
                        Nikmati Hanya
                        Di Archie Store</div>
                </div>
            </div>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">ARCHIE STORE
                    </div>
                    <form action="<?= site_url('register') ?>" method="post">
                        <div class="intro-x mt-8">
                            ...
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4"
                                placeholder="Kata Sandi" name="password_1" autocomplete="off">
                            ...
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4"
                                placeholder="Konfirmasi Kata Sandi" name="password_2" autocomplete="off">
                        </div>
                        <div
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button type="submit"
                                class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Mendaftar</button>
