                        ...
                        <tbody>
                            ...
                            foreach ($this->cart->contents() as $items): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <form action="<?= site_url('dashboard/remove') ?>" method="post">
                                            <input type="hidden" name="rowid" value="<?= $items['rowid']; ?>">
                                            <button type="submit" class="btn btn-danger"><i data-lucide="trash-2"
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="5" class="text-right"><strong>Total: Rp.
